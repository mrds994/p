...
const vcard = 'BEGIN:VCARD\n' //jangan ganti Sayang
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6281977817791:+6281977817791\n'  //ganti nomor kamu sayang
...
namabot = 'MRDS BOT'
cr = '*「 MRDS BOT」*' //ganti nama bot
lolkey = '682aeab645ed61cf137cf971' //apiknya ya sayang
/******** OWNER NUMBER**********/

const ownerNumber = ["6281977817791@s.whatsapp.net"]   //ganti nomor kamu sayang
...
client.version = [2, 2119, 6]
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('QR code is ready, Scan now..','white'),color('fb mrdskerツ','red'),color('X','lime'),color('LolHuman','red'))
})
            ...
            if (bad.includes(messagesC)) {
                if (!isGroupAdmins) {
                    return reply("JAGA UCAPAN DONG!! 😠")
                        ...
                        .then(() => {
                            client.sendMessage(from, `*「 ANTI BADWORD 」*\nGweh akan kick kamu karena berkata kasar!`, text ,{quoted: mek})
...
client.deleteMessage(from, { id: mek.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: true })
		...
		case 'transfer':
				...
				if (!q.includes('|')) return  reply(ind.wrongf())
                		...
                		addKoinUser('6281977817791@s.whatsapp.net', fee)
...
case 'addbadword':
		...
		case 'giftlimit': 
				...
				const nomerr = args[0].replace('@','')
                		...
                		if (!nomerr) return reply(`maaf format salah\nmasukan parameter yang benar\ncontoh : ${prefix}giftlimit @6281977817791 20`)
...
break
		...
		case 'info':
					...
					teks = `*INFO OWNER*\n*Owner bot* : MrDs${FN}\n*No Owner* : wa.me/6281977817791\n*fb owner* : Yusuf R\n━━━━━━━━━━━━━━━━━━━━\n*INFO BOT*\n*Nama bot* : MrDsBot${me.name}\n*Nomor bot* : 6287860442722@${me.jid.split('@')[0]}\n*Prefix* : ${prefix}\n*Total block contact* : ${blocked.length}\n*The bot is active on* : ${kyun(uptime)}\n*Ketik* : ${prefix}lpr _Untuk melaporkan admin bot melalui bot_\n*Ketik* : ${prefix}owner untuk menghubungi admin bot kami.`
		...
		case 'lpr':
					...
					client.sendMessage('6281977817791@s.whatsapp.net', options, text, {quoted: mek})
					reply('Bug = Fitur')
					break
					case 'antidelete':
 ...
 @${mentioned[0].split('@')[0]} 🤭`, mentioned, true)
		...
		case 'welcome':
				...
				case 'join':  
                    ...
                    fernazer.sendMessage(`${setting.ownerNumber}@s.whatsapp.net`, optionsp, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "caption": `Yusuf Ganteng Coi`} } } })                    
...
//DOWNLOAD MENU
		...
		if (budy.includes(`6281977817791`)) {
